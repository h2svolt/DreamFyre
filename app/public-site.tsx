...
function H2SVoltBanner() {
  return <a className="h2svolt-banner" href="https://www.h2svolt.com/" target="_blank" rel="noopener noreferrer">
    <Image src="/assets/poweredbyh2svolt.jpeg" alt="Powered by H2S Volt — Build. Innovate. Elevate." width={1536} height={1024} unoptimized/>
  </a>;
}

function PublicFooter() {
  return <footer className="public-footer"><div className="public-footer-top"><div><Brand compact/><p>One secure portal for casino accounts, payments, player support and rewards.</p><span className="age-mark">21+</span></div><div><strong>Explore</strong><Link href="/games">All games</Link><Link href="/promotions">Promotions</Link><Link href="/support">Help centre</Link></div><div><strong>Legal</strong><Link href="/legal/terms">Terms & conditions</Link><Link href="/legal/privacy">Privacy policy</Link><Link href="/legal/responsible-gaming">Responsible gaming</Link><Link href="/legal/cookies">Cookie policy</Link><Link href="/legal/disclaimer">Disclaimer</Link></div><div><strong>Account</strong><Link href="/auth?mode=login">Player sign in</Link><Link href="/auth?mode=register">Create account</Link><Link href="/auth?staff=1">Staff portal</Link></div></div><H2SVoltBanner/><div className="public-footer-bottom"><span>© {new Date().getFullYear()} DreamFyre. All rights reserved.</span><span>Play responsibly. Eligibility and local restrictions apply.</span></div></footer>;
}
